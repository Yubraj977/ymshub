...
export default async function ActionPage() {
  try {
    const res = await fetch('https://api.themoviedb.org/3/discover/movie?with_genres=28&language=en-US&page=1&sort_by=popularity.desc', {
      headers: {
      ...
      <div className="px-4">
        <div className="text-center mt-10 mb-6">
          ...
          <p className="text-gray-400 mt-2">
            Heart-pounding action and thrilling adventures
          </p>
        </div>
    ...
    return (
      <div className="flex justify-center items-center mt-10">
        <p className="text-red-400 text-xl">Failed to load action movies. Please try again later.</p>
      </div>
    );
  }
}